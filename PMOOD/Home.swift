...
//  PMOOD
//
//  Created by alanoud alawwad on 18/09/1444 AH.
//
        ...
        NavigationView {
            ...
            VStack{
                    ...
                    .frame(width: 360, height: 140).overlay(
                        ...
                        VStack{
                            ...
                            name.fontWeight(.bold)
                                .multilineTextAlignment(.trailing).padding(.leading,130)
                        }
                    )
                ...
                Text("Roccmandition for you mood")
                    ...
                    .multilineTextAlignment(.leading).padding(.trailing,80).padding(.top,20)
